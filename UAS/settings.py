...
SECRET_KEY = 'django-insecure-pff$@#rd8v&+q^o94pu+fa5fx@1$n6#1#@a$w1#qj-4_yr_p$z'
...
STATIC_URL = '/kmeans_project/templates/projects/'
STATICFILES_DIRS = os.path.join(BASE_DIR, 'kmeans_project/templates/projects'),
